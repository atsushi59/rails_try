class SomeController < ApplicationController
    def search
      ...
      user_input = "足立区西竹の塚から#{selected_transport}で#{selected_time}以内で#{selected_age}歳の子供が#{selected_activity}できる場所を正式名称のみ10件提示してください 条件、立ち入りの許可が必要ない、公式のHPが存在する場所、公共の施設のみ"
